...
& winget download GitHub.GitHubDesktop -d $Tempfolder --accept-package-agreements --accept-source-agreements
& winget download Microsoft.DotNet.DesktopRuntime.8 -d $Tempfolder --accept-package-agreements --accept-source-agreements
